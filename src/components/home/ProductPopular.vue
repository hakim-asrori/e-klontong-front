...
import { CRow, CCol, CCard, CCardBody, CCardImage, CCardTitle, CCardText, CSpinner, CModal, CModalHeader, CModalTitle, CModalBody, CImage, CModalFooter, CButton } from '@coreui/vue'
...
<template>
  <div class="mb-3 d-flex align-items-center justify-content-between">
    <h4 class="fw-bold">Popular Products</h4>
    <router-link :to="{ name: 'productList', params: { type: 'all-populars' } }"
  ...
  <div class="d-flex gap-3 overflow-x-auto content" v-else>
    <CCard v-for="(product, index) in products" :key="index" class="mb-3 card"
      style="max-width: 175px; width: 100%; min-width: 175px; cursor: pointer;" @click="toDetailProduct(product.slug)">
