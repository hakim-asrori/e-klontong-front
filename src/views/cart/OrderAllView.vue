...
const handleSubmit = async () => {
  ...
  let body = {
    ...
    item_ids: [],
    address: `${address.value.detail}, ${address.value.city}, ${address.value.prefektur}`,
...
<template>
  <form action="" @submit.prevent="handleSubmit" method="post">
    ...
    <p
      v-if="cart && cart.items && cart.items.length < 1"
        ...
        <CCardBody>
          ...
          >
            <div class="d-flex w-100">
              ...
              >
                <span class="text-capitalize ms-3 fw-semibold"
            ...
            <div class="d-flex gap-4 text-dark">
              ...
              <p v-if="address" class="m-0 p-0">
                ...
                <small>{{
                  `${address.detail}, ${address.city}, ${address.prefektur}`
                }}</small>
              </p>
        ...
        <CCardBody>
          ...
          <div class="mb-3" v-for="(cart, index) in cart.items">
            <div class="d-flex gap-2 align-items-center">
              ...
              <div
                class="d-flex flex-column justify-content-between gap-4 w-100"
              >
    ...
    <CCard class="fixed-bottom rounded-0 border-top border-0">
      <CCardBody class="py-2">
        <div class="d-flex align-items-center justify-content-between">
          <div>
            <small>Total :</small>
            <h5 class="m-0 p-0 fw-bold text-primary">
