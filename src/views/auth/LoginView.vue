...
<template>
  <CForm
    class="d-flex align-items-center flex-column justify-content-center gap-4 mt-5"
    method="post"
  ...
  >
    ...
    <div class="text-center">
      ...
      <h3 class="m-0 p-0">
        to Kenshuu <span class="text-danger">Express</span>
      </h3>
    </div>
    <div class="container">
      <div class="mb-3">
      ...
      <div class="mb-4">
        ...
        <div
          ...
          v-for="(error, index) in validation.password"
          :key="index"
        >
          {{ error }}
        </div>
      ...
      <CButton
        type="submit"
        color="primary rounded-pill w-100 mb-3"
        :disabled="isLoading"
        >Sign In</CButton
      >
      ...
      <p class="m-0 p-0 text-center">
        Don't have account?
        <span class="text-primary pointer-cursor" @click="toRegister()"
          >Sign Up</span
        >
      </p>
    </div>
